...
import { FairStatusDialog } from "~/components/fairs/status-toggle";


const columns: ColumnDef<FairProps>[] = [
  {
    accessorKey: "dp",
    header: "Profile",
    cell: ({ row }) => (
        ...
        <Tooltip>
          <TooltipTrigger asChild>
            <div className="flex items-center gap-1 max-w-[200px] truncate">
              ...
              <span className="text-sm text-gray-600">{row.getValue("address")}</span>
            </div>
          </TooltipTrigger>
          <TooltipContent>
...
export const FairTable = () => {
  ...
  const [fairs, { refetch }] = api.fair.getAllFairs.useSuspenseQuery();
      ...
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div>
          <h2 className="text-2xl font-bold text-gray-900">
            Fair Organizers Directory
          </h2>
          <p className="text-sm text-gray-500">
            Manage and view all registered fair organizers
          </p>
        </div>
              ...
              <TableRow>
                ...
                >
                  <div className="flex flex-col items-center justify-center gap-2">
                    ...
                    <span className="text-gray-500">No fair organizers found</span>
