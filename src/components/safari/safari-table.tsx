...
import { SafariStatusDialog } from "~/components/safari/status-toggle";


const columns: ColumnDef<SafariProps>[] = [
  {
    accessorKey: "dp",
    header: "Profile",
    cell: ({ row }) => (
          ...
          <DropdownMenu>
            ...
            <DropdownMenuContent align="end" className="w-[180px]">
              ...
              <DropdownMenuItem asChild>
                <SafariStatusDialog
                  safariId={row.original.safariId}
...
export const SafariTable = () => {
  ...
  const [safaris, { refetch }] = api.safari.getAllSafaris.useSuspenseQuery();
      ...
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div>
          <h2 className="text-2xl font-bold text-gray-900">
            Safari Guides Directory
          </h2>
          <p className="text-sm text-gray-500">
            Manage and view all registered safari guides
          </p>
        </div>
              ...
              <TableRow>
                ...
                >
                  <div className="flex flex-col items-center justify-center gap-2">
                    ...
                    <span className="text-gray-500">No safari guides found</span>
